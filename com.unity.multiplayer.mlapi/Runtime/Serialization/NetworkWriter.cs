    ...
    public class NetworkWriter
    {
        ...
        public void WriteObjectPacked(object value)
        {
            ...
            else if (value is NetworkObject)
            {
                ...
                {
                    throw new ArgumentException($"{nameof(NetworkWriter)} cannot write {nameof(NetworkObject)} types that are not spawned. {nameof(GameObject)}: {((NetworkObject)value).name}");
                }
            ...
            else if (value is NetworkBehaviour)
            {
                ...
                {
                    throw new ArgumentException($"{nameof(NetworkWriter)} cannot write {nameof(NetworkBehaviour)} types that are not spawned. {nameof(GameObject)}: {((NetworkBehaviour)value).name}");
                }
